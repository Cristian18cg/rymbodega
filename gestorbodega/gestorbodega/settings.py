"""
Django settings for gestorbodega project.
...
SECRET_KEY = 'django-insecure-p(p_u+^l-z+2&^a29hm*vw3qdgy-9c82w#02u_i5l+feci5n)1'
...
ROOT_URLCONF = 'gestorbodega.urls'
...
WSGI_APPLICATION = 'gestorbodega.wsgi.application'
